                                        ...
                                        for (let [ak, teama] of teamainnKey.entries()) {
                                            ...
                                            if (teama != '') { 
                                                ...
                                                if (bat != -1) {
                                                    ...
                                                    if (!innplayers[value][i] && !innplayers[value][i]['batting']) { console.log("b1 (!")
                                            ...
                                            if (play['batting'] || play['bowling'] || play['fielding']) {
                                                ...
                                                if (play['batting']) { 
                                                    ...
                                                    if (play['batting']['dismissal']) {
                                                        ...
                                                        if (player.playersData.role != 'bowler') {
                                                            if ((runs == 0) && (play['batting']['dismissal'] != '')) { console.log("b1 ((")
                                                                datasv.duck = duck = 1;
                                                            } else {
                                                                datasv.duck = duck = 0;
                                                            }
                                                    ...
                                                    if (play['batting']['dismissal'] == 'lbw' || play['batting']['dismissal'] == 'bowled') { console.log("b1 play")
                                                ...
                                                // fielding points //
                                                if (play['fielding'] != '' && play['fielding'] != undefined) { console.log("b1 play")
    ...
    async updateMatchscore(req){
        try{console.log("hello")
            ...
            // console.log("updatescoreDataabcd"+JSON.stringify(updatescoreData)+"req.body.matchkey"+req.body.matchkey+"req.body.playerid"+req.body.playerid)
                const real_matchkey = await listMatchesModel.find({_id:req.body.matchkey})
               ...
               this.playerPoint(req.body.matchkey, real_matchkey[0].format);
